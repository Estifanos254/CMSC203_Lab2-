...
public class FXMainPane extends VBox {
	...
	Button btn1, btn2, btn3, btn4, btn5, btnAmh;
	Label mainLabel;
	TextField txtField;
	...
	FXMainPane() {
		...
		btnAmh = new Button("Amharic");//  this one added just for fun
		...
		HBox.setMargin(btn2,new Insets(20, 20, 20, 20));
		HBox.setMargin(btn3,new Insets(20, 20, 20, 20));
		HBox.setMargin(btnAmh,new Insets(20, 20, 20, 20));
		HBox.setMargin(btn4,new Insets(20, 20, 20, 20));
		HBox.setMargin(btn5,new Insets(20, 20, 20, 20));
		...
		firstBox.getChildren().addAll(btn1, btn2, btn3, btnAmh, btn4, btn5);
		...
		// Optional Task
		btnAmh.setOnAction(new ButtonHandler());
	...
	class ButtonHandler implements EventHandler<ActionEvent> {
		...
		public void handle(ActionEvent event) {
			...
			case "Chinese":
				...
				break;
			case "Amharic":
				txtField.setText(dataManager.getAmharic());
				break;
			case "Clear":
				txtField.setText("");
				break;
